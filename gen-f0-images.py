...
def dowork_only2(
    Z0, Z1, N0, N1, T0, T1, trimesh, r, z, fsum, inode, title, outdir, seq, save=True
):
...
if __name__ == "__main__":
    ...
    group.add_argument(
        "--grey", help="grey", action="store_const", dest="mode", const="grey"
    )
    group.add_argument(
        "--grey4x",
        help="grey 4x low-resolution",
        action="store_const",
        dest="mode",
        const="grey4x",
    )
    group.add_argument(
        "--only2", help="only2", action="store_const", dest="mode", const="only2"
    )
    group.add_argument(
        "--full", help="full", action="store_const", dest="mode", const="full"
    )
